...
import (
	autenticacao "api/src/aunteticacao"
	"api/src/banco"
	"api/src/entities"
...
// BuscarSeguidindo traz os usuarios que um usuario segue
...
func AtualizarSenha(w http.ResponseWriter, r *http.Request) {
	...
	if erro = seguranca.VerificarSenha(senhaSalvaNoBanco, senha.Atual); erro != nil {
		respostas.Erro(w, http.StatusUnauthorized, errors.New("a senha atual não corresponde com a senha salva no banco"))
		return
	}
