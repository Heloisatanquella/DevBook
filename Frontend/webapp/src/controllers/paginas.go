...
// CarregarTelaLogin renderiza a tela de cadastro
func CarregarTelaCadastro(w http.ResponseWriter, r *http.Request) {
	utils.ExecutarTemplate(w, "register.html", nil)
}

// CarregarPaginaPrincipal renderiza a tela home com as publicacoes
func CarregarPaginaPrincipal(w http.ResponseWriter, r *http.Request) {
	...
	utils.ExecutarTemplate(w, "home.html", struct {
		Publicacoes []entities.Publicacao
		UsuarioID   uint64
	}{
...
// CarregarPaginaDeUsuarios renderiza na tela os usuarios que atendem o filtro passado
...
// CarregarPerfilDoUsuario renderiza a tela de perfil do usuario
